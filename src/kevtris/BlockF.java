 ...
 * BlockF.java
 *
 * Created on March 14, 2008, 11:11 PM
 *
 */
...
/**
 * This class defines the block F. Block F extends the
 ...
 * @version 1.0
 */
public class BlockF extends BlockAbstract {
    ...
    public BlockF() {
        ...
        blocks[2] = new BuildingBlock(this, 2, KevtrisConstants.GAP * 2, 0);
        blocks[3] = new BuildingBlock(this, 3, KevtrisConstants.GAP, KevtrisConstants.GAP);
        
        int tempPosition;
        // 0 -> 1
        tempPosition = 0;
        rotationalMovementDelta[tempPosition][KevtrisConstants.X_VALUES][0] = KevtrisConstants.GAP;
        ...
        rotationalMovementDelta[tempPosition][KevtrisConstants.Y_VALUES][0] = KevtrisConstants.GAP;
        ...
        for(int i=0; i<blocks.length; i++) {
            blocks[i].setColors(100, 100, 255);
        }
